...
## The statistic at the paper's scale (2026-09-17, 01:00-05:00)

`runs/phase1`: 1,008 seeds (1000-2007), 2^17 programs, 16,384 epochs, eight soups per process on six GPUs, four hours.
Transition = high-order entropy ≥ 1 at a 64-epoch log point.

| | paper | here |
| --- | --- | --- |
| runs | 1,000 | 1,008 |
| transition within 16k epochs | 40 % | 38.1 % (95 % Wilson interval 35.1-41.1 %) |
| transition epoch quartiles | spread 2k-12k (Fig. 6) | 2,480 / 5,280 / 10,896 |

Histogram: `experiments/results/phase1_transitions.png`.
Phase 1 is closed: exact against the reference, and the headline statistic reproduced at the paper's size and run count.
