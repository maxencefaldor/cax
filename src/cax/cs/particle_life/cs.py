...
This module implements Particle Life, a particle-based system where particles of
different types (classes) interact through pairwise attraction and repulsion forces. The
interaction strength between particle types is defined by an attraction matrix, creating
diverse emergent behaviors such as clustering, orbiting, and complex self-organizing
structures. Unlike Boids, Particle Life uses distance-dependent forces that can be both
attractive and repulsive, enabling richer dynamics and pattern formation.
"""
