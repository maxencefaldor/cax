...
class ParticleLifeUpdate(Update[ParticleLifeState, ParticleLifePerception, Array]):
    ...
    def __call__(
        ...
        Args:
            state: ParticleLifeState containing current class_id, position, and velocity
                arrays with shape (num_particles, num_spatial_dims).
        ...
        Returns:
            New ParticleLifeState with updated positions and velocities (class
            unchanged).
