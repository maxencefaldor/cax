...
Computes spatial statistics of a Lenia state on a toroidal grid using circular
statistics. These metrics drive fitness evaluation, degeneration detection, and state
centering in quality-diversity search loops.
"""
...
def metrics_fn(state: Array, *, R: int) -> dict[str, Array]:
    ...
    spatial concentration. The concentration measures how localized the mass
    distribution is on the torus (1 = point mass, 0 = uniform), computed as the product
    of per-axis mean resultant lengths.
