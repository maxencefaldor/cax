...
This module implements Boids, a particle-based system that simulates the flocking
behavior of birds or fish through simple local rules. Each boid (bird-like object)
adjusts its velocity based on the boid policy. These local interactions produce emergent
global flocking patterns without centralized coordination.
"""
...
class Boids(ComplexSystem[BoidsState, Array]):
    ...
    def render(
        ...
        *,
        ...
        Args:
            state: BoidsState containing position and velocity arrays. Position should
                have shape (num_boids, 2) with coordinates in [0, 1]. Velocity
                determines the orientation and can have arbitrary magnitude.
        ...
        closest_vertices = vertices[
            closest_idx, :, :
        ]  # Shape: (resolution, resolution, 3, 2)
