...
This module implements Elementary Cellular Automata, one-dimensional cellular automata
where each cell's next state depends on its current state and that of its two immediate
neighbors. Elementary Cellular Automata are classified by Wolfram rule numbers (0-255),
which define the transition function for all possible three-cell neighborhoods.
"""
