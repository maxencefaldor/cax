...
particles interact through continuous field potentials. Unlike grid-based Lenia,
particles move freely in continuous space and experience forces derived from kernel and
growth fields computed from neighboring particles.
